      ...
      <div className="bg-background text-foreground min-h-screen">
        ...
        <section className="pt-24 pb-16">
          <div className="container mx-auto px-4 text-center">
            <h1>
              THE BRIDGE BETWEEN INNOVATION <br/> AND OPPORTUNITY
            </h1>
            ...
            <div className="flex justify-center gap-4">
              <Button size="lg" className="bg-primary text-primary-foreground rounded-full">
                Explore Events
              </Button>
              <Button
                size="lg"
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            <p className="text-lg text-center mx-auto max-w-4xl">
              ...
              bring together brilliant minds to share ideas, build connections,
              and create opportunities. From budding entrepreneurs to seasoned
              professionals, our monthly networking events are the perfect space
              to pitch your startups, discover new innovations, secure funding,
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <blockquote className="text-lg italic">
              “NetworQ helped me pitch my startup to investors, and now
              we're scaling like never before!”
            </blockquote>
            <p className="text-primary font-bold mt-4">— Sara Ahmed, Founder of TechNova</p>
          </div>
        </section>
      </div>
